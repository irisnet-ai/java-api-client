...
public class AgeEstimationSubChecks {
  ...
  public boolean equals(Object o) {
    ...
    AgeEstimationSubChecks ageEstimationSubChecks = (AgeEstimationSubChecks) o;
    return Objects.equals(this.faceLivenessCheck, ageEstimationSubChecks.faceLivenessCheck) &&
        Objects.equals(this.ageValidationCheck, ageEstimationSubChecks.ageValidationCheck);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgeEstimationSubChecks {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgeEstimationSubChecks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgeEstimationSubChecks is not found in the empty JSON string", AgeEstimationSubChecks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AgeEstimationSubChecks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AgeEstimationSubChecks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgeEstimationSubChecks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgeEstimationSubChecks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgeEstimationSubChecks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgeEstimationSubChecks.class));

       return (TypeAdapter<T>) new TypeAdapter<AgeEstimationSubChecks>() {
           @Override
           public void write(JsonWriter out, AgeEstimationSubChecks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AgeEstimationSubChecks read(JsonReader in) throws IOException {
