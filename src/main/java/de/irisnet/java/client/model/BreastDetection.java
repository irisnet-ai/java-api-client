...
public class BreastDetection extends BaseDetection {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BreastDetection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BreastDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BreastDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BreastDetection` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
