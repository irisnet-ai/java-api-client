...
public class BaseDetection {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BaseDetection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BaseDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
