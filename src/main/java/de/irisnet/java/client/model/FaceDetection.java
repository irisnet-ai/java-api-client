...
public class FaceDetection extends BaseDetection {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FaceDetection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FaceDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FaceDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaceDetection` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
